...
public class ViewDongVat extends javax.swing.JFrame {
    ...
    private final QuanLyDongVatService quanLyDongVatService = new QuanLyDongVatService();
    ...
    public ViewDongVat() {
        ...
        dcbm.addAll(quanLyDongVatService.getAllNamSinh());
        dcbm.setSelectedItem(1990);
        showDataTable(quanLyDongVatService.getAll());
        DongVat dongVat = quanLyDongVatService.getAll().get(0);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        JOptionPane.showMessageDialog(this, quanLyDongVatService.addDongVat(getDataForm()));
        showDataTable(quanLyDongVatService.getAll());
    }//GEN-LAST:event_btnThemActionPerformed

    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        int row = tbHienThi.getSelectedRow();
        JOptionPane.showMessageDialog(this, quanLyDongVatService.updateDongVat(row, getDataForm()));
        showDataTable(quanLyDongVatService.getAll());
    }//GEN-LAST:event_btnSuaActionPerformed

    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        int row = tbHienThi.getSelectedRow();
        JOptionPane.showMessageDialog(this, quanLyDongVatService.removeDongVat(row));
        showDataTable(quanLyDongVatService.getAll());
    ...
    private void tbHienThiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbHienThiMouseClicked
        int row = tbHienThi.getSelectedRow();
        DongVat dongVat = quanLyDongVatService.getAll().get(row);
        detailDongVat(dongVat);
